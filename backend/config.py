...
class Config:
    ...
    ADMIN_EMAILJS_ANNOUNCEMENT_TEMPLATE_ID = os.getenv("ADMIN_EMAILJS_ANNOUNCEMENT_TEMPLATE_ID", "template_announcement")
    ADMIN_EMAILJS_POLICY_TEMPLATE_ID       = os.getenv("ADMIN_EMAILJS_POLICY_TEMPLATE_ID", "template_policy")